    ...
    >
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
        <span
          ...
          style={{ fontSize: '0.9rem', color: 'var(--theme-text-dim)' }}
        >
          {value === '$0' ? '' : 'USD'}
        </span>
        <span
          ...
          style={{
            fontSize: '3rem',
            color: value === '$0' ? 'var(--theme-text-primary)' : accent,
            lineHeight: 1,
          }}
        >
          {value}
  ...
  return (
    ...
    >
      <span
        ...
        style={{ fontSize: '0.85rem', position: 'relative', zIndex: 2 }}
      >
        {label}
      </span>
      {primary && (
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: isMobile ? '32px 16px 36px' : '40px 32px 44px',
        position: 'relative',
        overflow: 'hidden',
      }}
    >
      ...
      <div
        ref={headerRef}
        style={{ textAlign: 'center', marginBottom: 28, opacity: 0 }}
      >
        <span
        ...
        >
          One price.{' '}
          <span
            style={{ color: 'transparent', WebkitTextStroke: '1.5px #7c3aed' }}
          >
            Everything.
          </span>
        </h2>
      ...
      >
        ...
        <div ref={leftRef} style={{ ...cardBase, opacity: 0 }}>
          ...
          <div
            style={{
              ...
              height: 1,
              background:
                'linear-gradient(to right, transparent, var(--theme-border-hover), transparent)',
            }}
          />
        ...
        >
          ...
          >
            Already purchased?{' '}
            <span style={{ color: 'var(--theme-accent)', cursor: 'pointer' }}>
              Enter license key →
            </span>
          </p>
        </div>
