    ...
    <>
      ...
      >
        ...
        >
          ...
          <span
            className="font-mono text-[9px] px-2 py-0.5 rounded ml-1"
            style={{
              color: '#7c3aed',
      ...
      >
        ...
        {[...navLinks, { label: 'GitHub', path: '#' }].map((link, i) => (
          <button
            key={link.label}
            ref={(el) => {
            ...
            onClick={() =>
              link.path === '#' ? undefined : navAndClose(link.path)
            }
        ...
        <span
          className="absolute bottom-8 font-mono text-[10px]"
          style={{ color: '#404050' }}
        >
          © 2025 Kinetic UI
        </span>
