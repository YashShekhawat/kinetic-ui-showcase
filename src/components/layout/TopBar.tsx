      ...
      >
        ...
        >
          <button
            ...
            style={{
              background: !isBlocks ? '#0d0d16' : 'transparent',
              color: !isBlocks ? '#ededed' : '#505060',
              border: !isBlocks ? '1px solid #1a1a2e' : '1px solid transparent',
            }}
          >
            Components
          </button>
        ...
        <div className="flex-1 min-w-0">
          <input
            ...
            className="w-full max-w-[280px] py-1.5 px-3 rounded-md font-mono text-[11px] sm:text-[12px] outline-none"
            style={{
              background: '#0a0a12',
