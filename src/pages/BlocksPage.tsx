  ...
  return (
    <div className="min-h-screen" style={{ background: '#060608' }}>
      ...
      <div className="lg:ml-[220px] pt-12">
        {/* Pro banner */}
        <div className="sticky top-12 z-50" style={{ background: 'rgba(124,58,237,0.06)', borderBottom: '1px solid rgba(124,58,237,0.15)', padding: '10px 32px' }}>
          <div className="flex items-center justify-between max-w-[1000px] mx-auto">
            ...
            <button
              className="font-inter font-medium text-[12px] px-4 py-1.5 rounded text-white"
        ...
        <main className="max-w-[1000px] mx-auto px-8 pb-24 pt-8">
