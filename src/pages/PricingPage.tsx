...
import { blockCategories, blocks } from '@/config/components.config';
      ...
      {features.map((f, i) => (
        <li key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span
            ...
            style={{ fontSize: '0.8rem', color: '#b0b0c0', lineHeight: 1.4 }}
          >
    ...
    <div className="min-h-screen" style={{ background: '#060608' }}>
      ...
      >
        ...
        >
          ...
          <p
            className="font-inter font-light text-[15px]"
            style={{ color: '#909098' }}
          >
        ...
        >
          ...
          <div ref={leftRef} style={{ ...cardBase, opacity: 0 }}>
            <div
              style={{
                ...
                height: 1,
                background:
                  'linear-gradient(to right, transparent, #2a2a3e, transparent)',
              }}
            />
            ...
            <h3
              ...
              style={{ fontSize: '1.3rem', color: '#f0ede8', marginBottom: 4 }}
            >
              Starter
            </h3>
            <p
            ...
            >
              <span
                className="font-syne font-extrabold"
                style={{ fontSize: '3rem', color: '#f0ede8', lineHeight: 1 }}
              >
                $0
              </span>
              <span
          ...
          {!isMobile && (
            <div
              ...
              style={{
                ...
                flexShrink: 0,
                background:
                  'linear-gradient(to bottom, transparent, #7c3aed60, #7c3aed, #7c3aed60, transparent)',
                opacity: 0,
                alignSelf: 'stretch',
                position: 'relative',
              }}
          ...
          <div
            ref={rightRef}
            style={{ ...cardBase, opacity: 0, position: 'relative' }}
          >
            <div
              style={{
                position: 'absolute',
            ...
            >
              Every component, every block, every future addition. Yours
              forever.
            </p>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
                <span
                  className="font-syne font-extrabold"
                  style={{ fontSize: '0.9rem', color: '#707080' }}
                >
                  USD
                </span>
                <span
                  className="font-syne font-extrabold"
                  style={{ fontSize: '3rem', color: '#7c3aed', lineHeight: 1 }}
                >
                  $9
                </span>
              </div>
